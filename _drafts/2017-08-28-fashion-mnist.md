...
Before getting into the results section, I shall show an example of a $$1$$-hidden layer neural network implementation. Nonetheless, the whole code is available at my [Github profile](https://github.com/ricardokleinklein) in case you want to check anything out or you get stuck trying to add more layers/functionality. 
...
Surprisingly, the best score was obtained with the simplest neural network! In order to understand why, it is always a good idea to have a glimpse on the loss function values along the training phase. Below a comparison of the three loss function values is shown.

![Loss cross entropy function values](/images/fashion-MNIST/loss_several_layers.png)

As you can easily see, there is not a big difference among them. This is, the three of them reach similar loss values and remain stable on them, so the training is succesfull in recognising a great deal of patterns in the data. Another particular feature remarkable of discussion is the fact that the more layers not always mean more accuracy. Better said, it's not that easy, and there are many more details that should be kept in mind when implementing larger networks. 
...
* $$600$$ neurons -- Accuracy $$= 83.19$$%
* $$500$$ neurons -- Accuracy $$= 83.46$$%
* $$400$$ neurons -- Accuracy $$= 83.84$$%
* $$300$$ neurons -- Accuracy $$= 84.02$$%
* $$200$$ neurons -- Accuracy $$= 81.71$$%
* $$100$$ neurons -- Accuracy $$= 82.72$$%
* $$50$$ neurons -- Accuracy $$= 81.51$$%
* $$10$$ neurons -- Accuracy $$= 65.21$$%
...
![Loss cross entropy for several hidden units](/images/fashion-MNIST/cost_change_neurons.png)
